"""
main.py — Zomato Delivery Geospatial Data Sanitation Pipeline
=============================================================
Usage:
    python main.py                                    # expects data/Zomato_Dataset.csv
    python main.py --input path/to/Zomato_Dataset.csv
    python main.py --speed 60                         # stricter speed threshold
"""
